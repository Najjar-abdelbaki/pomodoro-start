...
canvas.create_image(100, 111, image=pomodoro_photo)
timer_text = canvas.create_text(100, 133, text="00:00", fill="white", font=(FONT_NAME, 30, "bold"))
...
tick_label = Label(text="", fg=GREEN, background=YELLOW)
